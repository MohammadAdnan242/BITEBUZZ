...
const Recipe = () => {
  ...
  return (
    <div className="relative container mx-auto px-4 py-8 bg-green-300 opacity-80">
      ...
      <h1 className="text-3xl font-bold text-center mb-4 text-orange-600 z-10 relative">
